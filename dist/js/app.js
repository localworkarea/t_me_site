 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".menu__slider")) new Swiper(".menu__slider", {
            ...
            if (document.querySelector(".slider-promo__slider")) new Swiper(".slider-promo__slider", {
            ...
            if (document.querySelector(".team__slider")) new Swiper(".team__slider", {
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                spaceBetween: 40,
        ...
        if (itemCases) itemCases.forEach((item => {
            const cursor = document.querySelector(".cursor-cases");
        ...
        if (formBrief) {
            ...
            function showCurrentBlock() {
                formBlocks.forEach(((block, index) => {
                    if (index === currentBlock) block.classList.remove("_hidden"); else block.classList.add("_hidden");
                }));
            }
            ...
            if (formBlocks.length > 0 && formBlocks[0].classList.contains("_hidden")) formBlocks[0].classList.remove("_hidden");
            window.addEventListener("DOMContentLoaded", (() => {
                ...
                lastFormCheckboxes.forEach((checkbox => {
                    checkbox.addEventListener("change", (() => {
                        ...
                        if (checkboxChecked) submitButton.classList.remove("disabled"); else submitButton.classList.add("disabled");
                    }));
                }));
            }));
        }
